...
void* stl::linear_allocator::allocate(const size_t size, const size_t alignment, const size_t alignment_offset, const stl::SourceInfo& info)
{
...
void stl::linear_allocator::free(void* object, const stl::SourceInfo& info)
{
}